...
| ```gaugeClass```     | The gauge class of the gauge (```gauge```) |
| ```valueClass```     | The value class of the gauge (```value```) |
| ```valueTextClass``` | The value text class of the gauge (```value-text```) |
| ```dialClass```      | The dail class of the gauge (```dial```) |
